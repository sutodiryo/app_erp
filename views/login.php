...
<head>
	...
	<title>Login - Cloud Sentragro</title>
	<!-- Favicon -->
				...
				<div class="header-body text-center mbx-7">
					<div class="row justify-content-center">
						<div class="col-xl-5 col-lg-6">
							<br>
							<br>
							<h1 class="text-white">Login Cloud Sentragro</h1>
							<br>
							<br>
							<br>
				...
				<div class="col-lg-5 col-md-7">
					<div class="card bg-secondary border-0 mb-0">
						<!-- <div class="card-header bg-transparent pb-5">
							...
							<div class="btn-wrapper text-center">
								<a href="#" class="btn btn-neutral btn-icon">
									<span class="btn-inner--icon"><img src="<?php echo ASSETS ?>img/icons/common/github.svg"></span>
									<span class="btn-inner--text">Github</span>
								</a>
								<a href="#" class="btn btn-neutral btn-icon">
									<span class="btn-inner--icon"><img src="<?php echo ASSETS ?>img/icons/common/google.svg"></span>
						...
						<div class="card-body px-lg-5 py-lg-5">
							...
							<form role="form" method="POST" action="<?php echo base_url('auth/proses_login/admin'); ?>">
